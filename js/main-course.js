// ============================================
// 🍛 MAIN COURSE SECTION – DYNAMIC PRODUCTS + SCROLL
// ============================================
(function () {
  ...
  function renderMainCourseStrip() {
    const track = document.getElementById('mainCourseTrack');
    if (!track || !window.products) return;

    const items = pickStableProducts('maincourse', 10);
    ...
    track.innerHTML = items
      .map((p, i) => {
        ...
        return `
          <a href="product-detail.html?id=${encodeURIComponent(p.id)}" class="main-course-card">
  ...
  document.addEventListener('DOMContentLoaded', function () {
    renderMainCourseStrip();
    initMainCourseScroll();
  });
})();
